...
;; Package-Version: 20260331.505
;; Package-Revision: 6f1bf124d0cf
...
;;;;;;; font lock
      ...
      (font-lock-function-name-face (:foreground ,syn-fun :weight medium))
      (font-lock-keyword-face (:foreground ,syn-keyword :weight medium
                                           :slant ,(if kanagawa-themes-keyword-italic 'italic 'normal)))
      (font-lock-operator-face (:foreground ,syn-operator :weight regular))
      (font-lock-negation-char-face (:inherit font-lock-keyword-face))
      (font-lock-preprocessor-face (:foreground ,syn-preproc :weight medium))
      (font-lock-regexp-grouping-construct (:foreground ,syn-regex :weight regular))
      (font-lock-regexp-grouping-backslash (:foreground ,syn-regex :weight regular))
      (font-lock-string-face (:foreground ,syn-string))
      (font-lock-number-face (:foreground ,syn-number :weight regular))
      (font-lock-type-face (:foreground ,syn-type :weight medium))
      (font-lock-variable-name-face (:foreground ,syn-variable :weight regular))
      (font-lock-property-use-face (:foreground ,syn-identifier))
      (font-lock-warning-face (:foreground ,diag-error :weight medium))
