...
(config-store-set
 '((lean-iv-font-size . 16) (lean-iv-port-wait-timeout . 60)
   ...
   (my/language-server-visible-render-margin . 8)
   ...
   (my/noema-roam-runtime-cli . "/Users/hc/.emacs.d/site-lisp/noema/roam-cli.mjs")
   (my/noema-roam-runtime-root . "/Users/hc/.emacs.d/site-lisp/noema")
   ...
   (my/noema-latex-export-max-attempts . 3) (my/noema-codex-model . "")
   (my/noema-latex-export-model . "") (my/noema-opencode-executable . "opencode")
   (my/project-local-overrides) (my/note-code-root . "/Users/hc/Documents/Noema/")
   ...
   (my/treemacs-cursor-follow-delay . 0.35) (my/treemacs-imenu-indent-width . 2) (my/project-import-project-el-entries)
   ...
   (inhibit-startup-screen . t) (inhibit-startup-message . t) (use-file-dialog)
   (use-dialog-box) (use-short-answers . t) (confirm-kill-emacs)
   ...
   (magent-session-directory
    . "/Users/hc/.emacs.d/var/noema/magent/sessions/")
   (magent-request-timeout . 180)
   (noema-interaction-magent-cli-max-json-line-bytes . 1048576)
   (noema-interaction-magent-cli-max-answer-bytes . 8388608)
   (noema-interaction-magent-cli-max-diagnostic-bytes . 262144)
   (noema-interaction-magent-cli-max-prompt-bytes . 4194304)
   (noema-interaction-magent-max-prompt-bytes . 2097152)
   (noema-interaction-magent-max-pending-per-project . 32)
   (noema-interaction-output-max-bytes . 16777216)
   (tramp-rpc-ssh-options "ConnectTimeout=5" "ConnectionAttempts=1")
   (remote-connection-open-timeout . 8) (lean-lsp-connect-timeout . 180)
   (lean-lsp-start-delay . 0.35)
   (lean-lsp-deferred-ui-delays (company . 0.15) (doc . 0.25) (inlay-hints . 0.45)
                                (semantic-tokens . 0.8)))
)
