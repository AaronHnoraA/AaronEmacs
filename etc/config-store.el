...
(config-store-set
 '((lean-iv-font-size . 16) (lean-iv-port-wait-timeout . 60)
   ...
   (my/latex-preview-open-timeout . 120.0)
   (my/pdf-view-auto-refresh-interval . 1.2)
   (my/auctex-live-save-idle-delay . 1.0)
   ...
   (my/copilot-idle-delay . 0.85) (my/macos-gc-after-minibuffer)
   ...
   (sentence-end-double-space) (word-wrap-by-category . t)
   (kill-whole-line . t) (kill-do-not-save-duplicates . t)
