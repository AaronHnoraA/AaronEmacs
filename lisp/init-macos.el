...
(declare-function my/org-roam-register-current-file "init-org-roam" ())
(declare-function my/org-roam-unregister-current-file "init-org-roam" ())
...
(autoload 'my/org-roam-register-current-file "init-org-roam" nil t)
(autoload 'my/org-roam-unregister-current-file "init-org-roam" nil t)
...
(use-package emacs
  ...
  (dolist (binding '(("f" . my/note-node-find)
