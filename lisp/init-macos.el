...
(use-package emacs
  ...
  (dolist (binding '(("a" . my/org-agenda)
                     ("b" . my/org-maintenance-board)
                     ("c" . org-capture)
                     ("f" . org-roam-node-find)
                     ("i" . org-roam-node-insert)
                     ("l" . org-roam-buffer-toggle)
                     ("n" . my/org-roam-register-current-file)
                     ("N" . my/org-roam-unregister-current-file)
                     ("g" . my/org-geogebra-tikz-clean-dwim)
                     ("G" . my/org-tikz-toggle-raw-fold-at-point)
                     ("m" . my/org-maintenance-rename-link-file)
                     ("k" . my/org-maintenance-protect-link-file)
                     ("O" . my/org-maintenance-open-link-system)
                     ...
                     ("V" . my/org-tikz-preview-display-latex-block)
                     ("w" . my/org-task-dispatch)
                     ("t" . org-todo)
                     ("s" . org-schedule)
                     ("d" . org-deadline)
                     ("r" . my/org-refile)
