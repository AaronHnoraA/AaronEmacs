...
(declare-function my/org-agenda "init-org-agenda" (&optional arg keys restriction))
...
(declare-function my/previewer-org-workbench "init-previewer" ())
(declare-function my/org-geogebra-tikz-clean-dwim "init-org-tikz" (&optional prompt))
(declare-function my/org-tikz-toggle-raw-fold-at-point "init-org-tikz" ())
(declare-function my/org-tikz-preview-display-latex-block "init-org-tikz" ())
...
(declare-function my/org-refile "init-org-agenda" (&optional arg default-buffer rfloc msg))
(declare-function my/org-toc-insert-or-update "init-org-core" (&optional depth))
(declare-function my/note-backlinks "init-note" ())
...
(declare-function my/note-db-sync "init-note" ())
(declare-function my/note-daily-today "init-note-capture" ())
(declare-function my/note-doctor "init-note" ())
(declare-function my/note-graph "init-note-graph" ())
(declare-function my/note-new "init-note" (title &optional tags directory))
(declare-function my/note-new-of-type "init-note" (type title &optional tags directory))
(declare-function my/note-node-find "init-note" ())
(declare-function my/note-node-insert "init-note" ())
(declare-function my/note-open-at-point "init-note" ())
(declare-function my/note-open-or-preview-sync "init-note" ())
(declare-function my/note-typst-export-pdf "init-note" (&optional mode))
(declare-function my/note-reference-create-target-dwim "init-note-reference" ())
(declare-function my/note-reference-insert "init-note-reference" (&optional current-only))
(declare-function my/note-tag-add "init-note-metadata" (tag))
(declare-function my/note-task-dispatch "init-note-agenda" ())
(declare-function my/note-paste-image-clipboard "init-note-tools" ())
(declare-function my/note-zotero-fill-metadata "init-note-tools" ())
(declare-function my/reference-insert-dispatch "init-note-reference" ())
...
(autoload 'my/org-agenda "init-org-agenda" nil t)
...
(autoload 'my/previewer-org-workbench "init-previewer" nil t)
(autoload 'my/org-geogebra-tikz-clean-dwim "init-org-tikz" nil t)
(autoload 'my/org-tikz-toggle-raw-fold-at-point "init-org-tikz" nil t)
(autoload 'my/org-tikz-preview-display-latex-block "init-org-tikz" nil t)
(autoload 'my/org-maintenance-board "init-org-maintenance" nil t)
(autoload 'my/org-maintenance-open-link-system "init-org-maintenance" nil t)
(autoload 'my/org-maintenance-protect-link-file "init-org-maintenance" nil t)
(autoload 'my/org-maintenance-rename-link-file "init-org-maintenance" nil t)
(autoload 'my/org-task-dispatch "init-org-agenda" nil t)
...
(autoload 'my/org-refile "init-org-agenda" nil t)
(autoload 'my/org-toc-insert-or-update "init-org-core" nil t)
(autoload 'my/note-alias-add "init-note-metadata" nil t)
(autoload 'my/note-agenda "init-note-agenda" nil t)
(autoload 'my/note-agenda-board "init-note-agenda" nil t)
(autoload 'my/note-backlinks "init-note" nil t)
(autoload 'my/note-capture "init-note-capture" nil t)
(autoload 'my/note-citation-insert "init-note-reference" nil t)
(autoload 'my/note-db-sync "init-note" nil t)
(autoload 'my/note-daily-today "init-note-capture" nil t)
(autoload 'my/note-doctor "init-note" nil t)
(autoload 'my/note-graph "init-note-graph" nil t)
(autoload 'my/note-new "init-note" nil t)
(autoload 'my/note-new-of-type "init-note" nil t)
(autoload 'my/note-node-find "init-note" nil t)
(autoload 'my/note-node-insert "init-note" nil t)
(autoload 'my/note-open-at-point "init-note" nil t)
(autoload 'my/note-open-or-preview-sync "init-note" nil t)
(autoload 'my/note-typst-export-pdf "init-note" nil t)
(autoload 'my/note-reference-create-target-dwim "init-note-reference" nil t)
(autoload 'my/note-reference-insert "init-note-reference" nil t)
(autoload 'my/note-tag-add "init-note-metadata" nil t)
(autoload 'my/note-task-dispatch "init-note-agenda" nil t)
(autoload 'my/note-paste-image-clipboard "init-note-tools" nil t)
...
(use-package emacs
  ...
  (define-prefix-command 'my/note-hyper-map)
  (dolist (binding '(("H-," . my/hyper-dispatch)
                     ...
                     ("H-p" . my/reference-insert-dispatch)
                     ...
                     ("H-y" . my/note-paste-image-clipboard)
  ...
  (dolist (binding '(("a" . my/note-alias-add)
                     ...
                     ("t" . my/note-tag-add)
                     ("y" . my/note-paste-image-clipboard)
                     ("z" . my/note-zotero-fill-metadata)))
    (define-key my/note-hyper-map (kbd (car binding)) (cdr binding)))
