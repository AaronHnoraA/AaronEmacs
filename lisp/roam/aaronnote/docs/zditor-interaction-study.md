# Zditor interaction study for Aaronnote
...
reviewed commit. Aaronnote therefore uses the public documentation only as a
behaviour and UX reference. No Zditor source code is copied.

## Adopted in Aaronnote-native form
...
- Complex typed YAML property objects. Aaronnote Roam metadata remains
  `org-env(meta)`-first.
