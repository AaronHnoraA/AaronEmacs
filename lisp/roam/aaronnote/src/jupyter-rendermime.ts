// Shared JupyterLab render stack for AaronNote cell outputs.
//
...
//
// AaronNote-specific adaptations layered on top of the stock factories:
//   * a KaTeX LaTeX typesetter (AaronNote never loads MathJax);
...
// The stock JupyterLab factories with AaronNote's HTML (iframe/KaTeX) renderer
