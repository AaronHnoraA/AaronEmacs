...
description: Structurally polish a Pandoc-generated Aaronnote LaTeX body while preserving all public source text exactly. Use for Aaronnote export review involving ambiguous lists such as (a)/(b), theorem/problem/solution structure, headings, citations, math, code, and explicit LaTeX marks.
---

# Aaronnote LaTeX Polish
