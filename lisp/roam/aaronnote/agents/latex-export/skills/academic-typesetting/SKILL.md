...
description: Audit and refine restrained academic LaTeX typography without changing content. Use for Aaronnote exports requiring template-aware spacing, page flow, lists, tables, figures, theorem/proof presentation, overfull-line prevention, and title fit.
---
