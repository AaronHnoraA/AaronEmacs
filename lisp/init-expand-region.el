...
(my/evil-global-leader-set "v v" #'my/expand-region "expand region")
(my/evil-global-leader-set "v V" #'my/contract-region "contract region")
(my/evil-global-leader-set "v f" #'my/select-defun "select defun")
(my/evil-global-leader-set "v F" #'my/select-inner-defun "select inner defun")
(my/evil-global-leader-set "v s" #'my/select-statement "select statement")
(my/evil-global-leader-set "v e" #'my/select-expression "select expression")
(my/evil-global-leader-set "v b" #'my/select-block "select block")
(my/evil-global-leader-set "v B" #'my/select-inner-block "select inner block")
(my/evil-global-leader-set "v p" #'my/select-parent-syntax-node "select parent")
