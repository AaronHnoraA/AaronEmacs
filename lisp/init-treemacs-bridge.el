...
(eval-and-compile
  (defmacro my/treemacs-bridge-declarations ()
    ...
    '(progn
       ...
       (declare-function treemacs-pulse-on-success "treemacs-visuals" (&rest log-args))
       ...
       (declare-function treemacs--find-index-pos "treemacs-tag-follow-mode" (point index))
       ...
       (defvar treemacs-pulse-on-success)
