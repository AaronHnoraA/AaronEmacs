;;; init-org-babel.el --- Org Babel configuration centered on ob-jupyter -*- lexical-binding: t -*-
...
(use-package org-src
  ...
  :bind (:map org-mode-map
         ("C-c C-v C-a" . my/org-babel-execute-src-block-async)
         ("C-c C-v C-k" . my/org-babel-cancel-current-async-job))
