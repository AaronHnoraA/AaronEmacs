...
(my/leader!
  ...
  "n d" '(:def my/navigation-find-definition :which-key "definition")
  "n r" '(:def my/navigation-find-references :which-key "references")
  "n i" '(:def my/navigation-find-implementation :which-key "implementation")
  "n t" '(:def my/navigation-find-type-definition :which-key "type definition")
  "n b" '(:def my/navigation-back :which-key "back")
  "n f" '(:def my/navigation-forward :which-key "forward")
  ...
  "n ]" '(:def my/navigation-next-defun :which-key "next defun")
  "n u" '(:def my/navigation-up-structure :which-key "up structure"))
