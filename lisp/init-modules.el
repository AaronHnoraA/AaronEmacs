...
(autoload 'my/calendar-year "init-calendar-tools" nil t)
(when (eq system-type 'darwin)
  (autoload 'my/macos-dispatch "init-macos-tools" nil t))
(my/require-module-after-any-feature 'init-org-tools 'org)
