...
(my/evil-global-leader-set "g ." #'my/git-dispatch "git hub")
(my/evil-global-leader-set "g g" #'magit-status "status")
(my/evil-global-leader-set "g w" #'my/git-board "git board")
(my/evil-global-leader-set "g t" #'my/git-tree "git tree")
(my/evil-global-leader-set "g l" #'my/git-file-log "file log")
(my/evil-global-leader-set "g B" #'my/git-file-blame-toggle "blame toggle")
(my/evil-global-leader-set "g S" #'my/git-stage-current-file "stage file")
(my/evil-global-leader-set "g U" #'my/git-unstage-current-file "unstage file")
