...
这套配置的使用文档统一放在 `docs/` 目录。

建议按下面顺序阅读：

1. [quick-start.md](quick-start.md)
   首次安装、依赖、字体、目录约定、bootstrap。
2. [daily-usage.md](daily-usage.md)
   日常高频操作、核心快捷键、leader 分组。
3. [project-guide.md](project-guide.md)
   项目管理、批量发现项目、项目切换、Treemacs / Perspective 联动。
4. [org-guide.md](org-guide.md)
   Org、agenda、capture、org-roam、LaTeX 预览、学术写作。
5. [dev-guide.md](dev-guide.md)
   LSP、补全、调试、项目导航、终端、远程、浏览器。
